...
TOKEN = "MTA3NjIyMDY4NDUyODc5NTY3OQ.Gw3A5U.G1R3Mhu7thkAe31bVHObLdJrBDNg2XSHkmetFU"
gif = ""
adet = 20
saniye = 0
...
async def on_ready():
    ...
    activity = discord.Activity(type=discord.ActivityType.playing, name="komutlar icin !yardim - berklaynexdddd")
